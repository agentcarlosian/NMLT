...
- Case 7 remainder: grades through *sync*, I-FAIR through sync (empty-wiring product pack frozen; VisibleSync I-CAP transfer independence checked below; T5 ≠ CONDITIONAL-CONGRUENCE);
...
- **Recorded 2026-08-27:** T1/T2/T4 axiom-free; T3/T5/T5a/T5b depend on
  ...
  `emptyWiring_hiddenRely_breaks_productResourceRefinement` are `[propext]` only
