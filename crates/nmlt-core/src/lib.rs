...
pub use untyped::{
    ...
    UntypedSurfaceNode, UntypedSystem, UntypedUpdateTarget, action_polarity, declared_polarity,
    hidden_action_names, hidden_wired_actions, non_complementary_declared_wires,
    non_complementary_port_wires, non_complementary_surface_wires, port_polarity, project_untyped,
    surface_action_polarities, surface_connections, surface_declared_polarities,
    surface_endpoint_wires, surface_endpoint_wires_for_left, surface_port_polarities,
    surface_wired_action_pairs, surface_wired_action_pairs_for_left, surface_wires,
    surface_wires_in_compose,
};
