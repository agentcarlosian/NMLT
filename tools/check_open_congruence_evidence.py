...
def expected_evidence() -> dict[str, Any]:
    ...
    value: dict[str, Any] = {
        ...
        "limitations": [
            ...
            "The bounded Rust kernel is translated by pinned Charon/Aeneas; it now executes structural equality against a separately reconstructed expected numeric certificate before validation, and Lean proves successful bound execution exposes that readback decision and the validation contract. Rust independently reads every active dictionary and source field back. The rich encoder, reconstruction, and Rust readback implementations remain outside verified extraction.",
